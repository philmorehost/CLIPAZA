...
function renderNav(bool $isLoggedIn, array $user = [], string $activeMode = '): void {
    ...
    echo '<a class="navbar-brand text-white text-decoration-none" href="index">' . $logoHtml . '</a>';
...
<footer class="lp-footer mt-auto">
  <div class="container">
    <div class="d-flex flex-column flex-md-row align-items-center justify-content-between gap-3">
      ...
      <div style="font-size:0.8rem;color:#ccc">&copy; {$year} {$siteName}. All rights reserved.</div>
    </div>
  </div>
</footer>
